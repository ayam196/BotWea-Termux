...
conn.welcome = 'Hai, @user👋!\nSelamat datang di grup @subject jangan lupa baca descripsion Group Dan Jangan Toxic ya'
conn.bye = 'Sayonnara @user!👋 Jasamu akan kami Rindukan'
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Perintag ini hanya dapat digunakan oleh _*HOST*_',
